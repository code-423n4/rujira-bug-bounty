...
- [Submit findings using the C4 form](https://code4rena.com/bounties/rujira/submit)
...
| RUJI Index | On-chain ready-made index tokens that track a whole basket of assets | [yRUNE Index](https://thorchain.net/address/thor1mlphkryw5g54yfkrp6xpqzlpv4f8wh6hyw27yyg4z2els8a9gxpqhfhekt). There are several instances of Index contracts deployed | [contracts](https://github.com/NAMIProtocol/nami-contracts/tree/audit/contracts) and [packages nami-rs](https://github.com/NAMIProtocol/nami-contracts/tree/audit/packages/nami-rs)| [docs](https://docs.rujira.network/core-products/ruji-index) |
